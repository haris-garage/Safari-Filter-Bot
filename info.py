...
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002215282062').split(','))))
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002058596719")) 
